...
import BscteResults from "@/Components/BscteResults";
...
export default function Bscte() {
    ...
    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this candidate?')) {
            router.delete(route('destroybscte', id), {
                preserveScroll: true,
                onSuccess: (page) => {
    ...
    const handleEdit = (id) => {
        if (editingCandidate) {
            router.post(route('updatebscte', id), {
                _method: 'put',
                ...data,
            }, {
                preserveScroll: true,
                ...
                <div className="p-4 sm:p-6">
                    ...
                    <div className="mb-8">
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">
                            CTE Candidates Management
                        </h1>
                        <p className="text-gray-600">Manage and monitor CTE department candidates</p>
                    </div>

                    {/* Results Section */}
                    <div className="mb-8">
                        <BscteResults candidates={candidateList} election={election} />
                    </div>
                                                ...
                                                <tr key={candidate.id} className="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-yellow-100 text-yellow-800">
                                                            {candidate.bscte_votes_count || 0} votes
                                                        </span>
                                                    </td>
                                                    <td className="px-6 py-4">
                        ...
                        >
                            ...
                            <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6 rounded-t-2xl">
                                ...
                                <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                                    ...
                                    {editingCandidate ? "Edit BSCTE Candidate" : "Add New BSCTE Candidate"}
                                </h2>
