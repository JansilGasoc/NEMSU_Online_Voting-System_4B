...
import BscsResults from "@/Components/BscsResults";
...
export default function Bscs() {
    ...
    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this candidate?')) {
            router.delete(route('destroybscs', id), {
                preserveScroll: true,
                onSuccess: (page) => {
    ...
    const handleEdit = (id) => {
        if (editingCandidate) {
            router.post(route('updatebscs', id), {
                _method: 'put',
                ...data,
            }, {
                preserveScroll: true,
                ...
                <div className="p-4 sm:p-6">
                    ...
                    <div className="mb-8">
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">
                            BSCS Candidates Management
                        </h1>
                        <p className="text-gray-600">Manage and monitor BSCS department candidates</p>
                    </div>

                    {/* Results Section */}
                    <div className="mb-8">
                        <BscsResults candidates={candidateList} election={election} />
                    </div>
                        ...
                        >
                            ...
                            <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6 rounded-t-2xl">
                                ...
                                <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                                    ...
                                    {editingCandidate ? "Edit BSCS Candidate" : "Add New BSCS Candidate"}
                                </h2>
