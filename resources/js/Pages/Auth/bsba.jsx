...
export default function Bsba() {
    ...
    const positions = [
        ...
        { name: "VP Finance", key: "vp_finance_id" },
    ...
    if (auth.user?.course_program !== "BSBA") {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Choose Deserving BSBA Candidates</h2>
