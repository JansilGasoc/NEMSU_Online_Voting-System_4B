...
export default function Bscte() {
    ...
    const positions = [
        ...
        { name: "VP Internal", key: "vp_internal_id" },
        { name: "VP External", key: "vp_external_id" },
        ...
        { name: "Layout Artist", key: "layout_artist_id" },
        { name: "Online Convener", key: "online_convener_id" },
        { name: "Ambassador", key: "ambassador_id" },
        { name: "Auditor", key: "auditor_id" },
        { name: "Ambassadress", key: "ambassadress_id" },
    ];
    ...
    const submitVote = (e) => {
        ...
        voteForm.post(route('bscte.vote'), {
            onFinish: () => setIsLoading(false),
        });
    };
    ...
    if (!['BSED', 'BEED'].includes(auth.user?.course_program)) {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Choose Deserving CTE Candidates</h2>
