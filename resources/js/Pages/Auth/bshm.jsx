...
export default function Bshm() {
    ...
    const positions = [
        ...
        { name: "VP Governor Internal", key: "vp_governor_int_id" },
        { name: "VP Governor External", key: "vp_governor_ext_id" },
        { name: "Secretary", key: "secretary_id" },
        { name: "Treasurer", key: "treasurer_id" },
        { name: "Auditor", key: "auditor_id" },
        { name: "P.I.O", key: "p_i_o_id" },
        { name: "Dept. Ambassador", key: "dept_ambassador_id" },
        { name: "Dept. Ambassadress", key: "dept_ambassadress_id" },
        { name: "Sargent at arms", key: "sgt_at_arms_id" },
        { name: "Fourth year representative", key: "fourth_year_representative_id" },
        { name: "Second year representative", key: "second_year_representative_id" },
    ];
    ...
    if (auth.user?.course_program !== "BSHM") {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Choose Deserving BSHM Candidates</h2>
