...
export default function BscsVoting() {
    ...
    const positions = [
        ...
        { name: "Vice Governor", key: "vice_governor_id" },
        { name: "Secretary", key: "secretary_id" },
        { name: "Treasurer", key: "treasurer_id" },
        { name: "Auditor", key: "auditor_id" },
        { name: "P.R.O", key: "p_r_o_id" },
        { name: "Events Manager", key: "events_manager_id" },
    ];
    ...
    if (auth.user?.course_program !== "BSCS") {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Choose Deserving BSCS Candidates</h2>
